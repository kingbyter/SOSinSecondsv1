...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        System.out.println("hioirrorijgroej");
    }
    ...
    public void storeContact(android.view.View view) {
        ...
        if(showString != null || showString.length() < 11) {
            contacts.add(showString);
        }
    }
        ...
        if (requestCode == PLACE_PICKER_REQUEST) {
            if (resultCode == RESULT_OK) {
                ...
                for(int i = 0; i < contacts.size(); i++) {
                    recipients += contacts.get(i) + " ";
                }
                String s = "PLEASE HELP I'm in an emergency! ~ Generated by S.O.S.inSeconds";
                String m = place.getName().toString() + ":  " + place.getAddress().toString();        //may also be Toast.makeText or place

                Intent intent = new Intent(Intent.ACTION_SEND);

                intent.putExtra(Intent.EXTRA_EMAIL, new String[] {recipients});
                intent.putExtra(Intent.EXTRA_SUBJECT, s + (" LOCATION: ") + m);
